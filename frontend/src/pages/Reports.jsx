...
function Reports() {
  ...
  // Report router is mounted under /api (backend/main.py) — these URLs must
  // go through API_BASE or they hit the SPA catch-all and return index.html.
  const reportUrl = `${API_BASE}/report/generate`;
  const latestReportUrl = `${API_BASE}/report/latest`;
